...
exports.run = (client, message, args) => {
  ...
  if(!message.member.roles.has('768485666014756915')) return message.channel.send('Bu komutu kullanabilmek için Arex Olmalısın')
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setImage("https://i.hizliresim.com/O1u6rw.gif");
