...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆ＹＥＴＫＩ◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\ 
  ...
  if(!message.member.roles.has('759441520234856518')) return message.channel.send('Bu komutu kullanabilmek için gerekli role sahip değilsin.')
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆ＤＯＫＵＮＭＡ◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\  
  ...
  data.add(`voiceMute.${mention.id}`, 1)
  
  let voiceMute = data.fetch(`voiceMute.${mention.id}`)
  
  data.add(`cezaPuan.${mention.id}`, 5)
  
  let cezapuan = data.fetch(`cezaPuan.${mention.id}`);
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆ＬＯＧ ＡＹＡＲＬＡＭＡ◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\
  ...
  data.add('case', 1)
  const sadxstg = await data.fetch('case')
  ...
  client.channels.get('763434386133352508').send(`${mention} ${time} boyunca ses kanallarında susturuldu. (\`#${sadxstg}\`)`)
  client.channels.get('763434386133352508').send(
    new Discord.RichEmbed()
    .setColor('RED')
    .setAuthor(message.author.tag, message.author.avatarURL)
    .setDescription(`${mention} (\`${mention.user.id}\`) üyesi ses kanalında bulunmadığı için susturulamadı. Sesli kanala bağlanınca süresi başlayacak.
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆ＭＥＴＩＮＬＥＲ◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\ 
  ...
  client.channels.get('763434386133352508').send(new Discord.RichEmbed().setColor('RED').setAuthor(message.author.tag, message.author.avatarURL).setDescription(`${mention} (\`${mention.user.id}\`) üyesi ses kanallarında susturuldu.
...
`))
  ...
  client.channels.get('763434386133352508').send(new Discord.RichEmbed().setColor('GREEN').setAuthor(message.author.tag, message.author.avatarURL).setDescription(`${mention} (\`${mention.user.id}\`) üyesinin ses kanallarında bulunan susturulması kaldırıldı.
